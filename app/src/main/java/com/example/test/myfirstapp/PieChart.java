...
public class PieChart extends ViewGroup {
    ...
    private boolean mShowTexts = false;
    ...
    public PieChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShowTexts = a.getBoolean(R.styleable.PieChart_showTexts, false);
     ...
     * the control.
     *
     * @param showTexts true if the text label should be visible, false otherwise
     */
    public void setShowTexts(boolean showTexts) {
        mShowTexts = showTexts;
        invalidate();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mTextPos == TEXTPOS_LEFT) {
            ...
            if (mShowTexts) mPieBounds.offset(mTextWidth, 0.0f);
